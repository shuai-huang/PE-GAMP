% Real image recovery using PE-GAMP with the Bernoulli-Gaussian mixture input channel and AWGN output channel. The optimal parameters and the sparse signal are estimated using sum-product message passing.
...
cluster_num = 10;   % the number of gaussian mixture components
...
optPE.L=cluster_num;
optGAMP.nit = 10;
[Xr, PEfin]=BGM_PE_GAMP(Y2, A2, optPE, optGAMP);
